...
def get_labels(main_sub_activity_str: str, verbose: bool = True) -> Tuple[int, int]:
    """
    ...
    :param verbose: boolean to control print statements that are generated by the function. Default: True
