...
SUB_ACTIVITY_LABELS = [CLASS_SIT,
                       CLASS_STAND_STILL, CLASS_STAND_TALK, CLASS_STAND_COFFEE, CLASS_STAND_FOLDERS,
                       CLASS_WALK_SLOW, CLASS_WALK_MEDIUM, CLASS_WALK_FAST, CLASS_WALK_STAIRS_UP, CLASS_WALK_STAIRS_DOWN]
...
SUBJECT_STATS_JSON = 'subject_statistics.json'
